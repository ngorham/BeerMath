 ...
 * {@link VolumeFragment.OnVolumeFragmentInteractionListener} interface
...
public class VolumeFragment extends Fragment {
    ...
    private OnVolumeFragmentInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onVolumeFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnVolumeFragmentInteractionListener) {
            mListener = (OnVolumeFragmentInteractionListener) context;
        } else {
    ...
    public interface OnVolumeFragmentInteractionListener {
        ...
        void onVolumeFragmentInteraction(Uri uri);
    }
}
